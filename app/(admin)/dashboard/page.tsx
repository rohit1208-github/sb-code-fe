...
import { 
  Building2, MessageSquare, Globe2, Users, 
  BarChart3, PieChart, TrendingUp, Share2,
  Activity, ArrowUpRight, ChartLineUp
} from "lucide-react"
...
const cardHoverClass = "transition-all duration-200 hover:scale-[1.02] hover:shadow-lg cursor-pointer"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className={cardHoverClass}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className={cn("text-sm font-medium", getCardTitleColor('traffic'))}>
              Lifetime Visitors
            </CardTitle>
            <Users className={cn("h-4 w-4", getCardTitleColor('traffic'))} />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{data?.statistics.lifetimeVisitors.count ?? 0}</div>
            <p className="text-xs text-muted-foreground">
      ...
      {data?.recentMenuItems && data.recentMenuItems.length > 0 && (
        <Card className={cardHoverClass}>
          <CardHeader>
            <CardTitle className={getCardTitleColor('branches')}>Recent Menu Updates</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className={cardHoverClass}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <div>
              <CardTitle className="text-base font-medium">Visitor Analytics</CardTitle>
              <p className="text-sm text-muted-foreground">Daily visitor count</p>
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className={cardHoverClass}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <ArrowUpRight className={cn("h-4 w-4", getCardTitleColor('social'))} />
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              <div className="flex items-center justify-between">
