      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-enhanced uppercase">Code</TableHead>
            <TableHead className="text-enhanced uppercase">Status</TableHead>
            <TableHead className="text-enhanced uppercase">Created At</TableHead>
            <TableHead className="text-enhanced uppercase">Updated At</TableHead>
        ...
        <TableBody>
          {countries?.map((country) => (
            <TableRow key={country.id}>
              <TableCell className="font-medium text-enhanced">{country.name}</TableCell>
