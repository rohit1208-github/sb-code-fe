  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="heading-enhanced bg-gradient-to-r from-indigo-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent">BRANCHES</CardTitle>
        <BranchDialog
          mode="add"
          trigger={
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-enhanced uppercase">Online Ordering</TableHead>
              <TableHead className="text-enhanced uppercase text-right">Actions</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {branches.map((branch) => (
              <TableRow key={branch.id}>
                <TableCell className="font-medium text-enhanced">{branch.name}</TableCell>
                <TableCell className="font-medium">{branch.country_name}</TableCell>
